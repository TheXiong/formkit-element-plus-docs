import{_ as m,d as u,p as y,B as d,o as F,c,G as k,w as t,b as s,a as i,t as C,F as B}from"./chunks/framework.CLtZAfjj.js";const b=u({name:"InputDemo",setup(){const a=y(),n=y();return{data:a,myForm:n,onSubmit:()=>(console.log(a.value,"submited"),new Promise(l=>{setTimeout(()=>{l()},1e3)})),optionsLoader:()=>new Promise(l=>{setTimeout(()=>{l({mercury:"Mercury",venus:"Venus",earth:"Earth",mars:"Mars",jupiter:"Jupiter",saturn:"Saturn",uranus:"Uranus",neptune:"Neptune"})},1e3)})}}});function D(a,n,h,E,l,r){const p=d("FormKit"),g=d("el-button");return F(),c(B,null,[k(p,{ref:"myForm",type:"el-form","label-position":"top",modelValue:a.data,"onUpdate:modelValue":n[0]||(n[0]=e=>a.data=e),onSubmit:a.onSubmit},{footer:t(({disabled:e,node:o})=>[k(g,{loading:e,disabled:e,type:"primary",onClick:o.submit},{default:t(()=>n[1]||(n[1]=[s("提交")])),_:2},1032,["loading","disabled","onClick"])]),default:t(()=>[k(p,{type:"el-select",name:"a",label:"a",validation:"required",optionsLoader:a.optionsLoader},null,8,["optionsLoader"])]),_:1},8,["modelValue","onSubmit"]),i("pre",null,C(a.data),1)],64)}const A=m(b,[["render",D]]),f=u({name:"InputDemo",setup(){const a=y(),n=y();return{data:a,myForm:n,onSubmit:()=>(console.log(a.value,"submited"),new Promise(l=>{setTimeout(()=>{l()},1e3)})),optionsLoader:l=>(console.log(l,"depData"),l!=null&&l.a?(l==null?void 0:l.a)==="1"?new Promise(r=>{setTimeout(()=>{r(["a1","b1","c1"])},1e3)}):new Promise(r=>{setTimeout(()=>{r(["a2","b2","c2"])},1e3)}):[])}}});function v(a,n,h,E,l,r){const p=d("FormKit"),g=d("el-button");return F(),c(B,null,[k(p,{ref:"myForm",type:"el-form","label-position":"top",modelValue:a.data,"onUpdate:modelValue":n[0]||(n[0]=e=>a.data=e),onSubmit:a.onSubmit},{footer:t(({disabled:e,node:o})=>[k(g,{loading:e,disabled:e,type:"primary",onClick:o.submit},{default:t(()=>n[1]||(n[1]=[s("提交")])),_:2},1032,["loading","disabled","onClick"])]),default:t(()=>[k(p,{type:"el-select",name:"a",label:"a",validation:"required",options:["1","2"],id:"a"}),k(p,{type:"el-select",name:"b",label:"b",validation:"required",optionsDepIds:["a"],optionsLoader:a.optionsLoader},null,8,["optionsLoader"])]),_:1},8,["modelValue","onSubmit"]),i("pre",null,C(a.data),1)],64)}const S=m(f,[["render",v]]),P=JSON.parse('{"title":"异步数据源","description":"","frontmatter":{},"headers":[],"relativePath":"guide/datasource.md","filePath":"guide/datasource.md","lastUpdated":1751513752000}'),L={name:"guide/datasource.md"},K=Object.assign(L,{setup(a){return(n,h)=>{const E=d("demo");return F(),c("div",null,[h[2]||(h[2]=i("h1",{id:"异步数据源",tabindex:"-1"},[s("异步数据源 "),i("a",{class:"header-anchor",href:"#异步数据源","aria-label":'Permalink to "异步数据源"'},"​")],-1)),h[3]||(h[3]=i("h2",{id:"基础用法",tabindex:"-1"},[s("基础用法 "),i("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),k(E,{customClass:"demoblock-custom",sourceCode:`<template>
  <FormKit
    ref="myForm"
    type="el-form"
    label-position="top"
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"})")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:t(()=>[k(A)]),_:1}),h[4]||(h[4]=i("h2",{id:"联动加载",tabindex:"-1"},[s("联动加载 "),i("a",{class:"header-anchor",href:"#联动加载","aria-label":'Permalink to "联动加载"'},"​")],-1)),k(E,{customClass:"demoblock-custom",sourceCode:`<template>
  <FormKit
    ref="myForm"
    type="el-form"
    label-position="top"
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"})")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:t(()=>[k(S)]),_:1})])}}});export{P as __pageData,K as default};
