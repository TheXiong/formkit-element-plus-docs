import{_ as m,d as c,p as y,B as d,o,c as F,G as n,w as h,b as s,a as i,t as u,F as b,aS as f}from"./chunks/framework.CLtZAfjj.js";const D=c({name:"InputDemo",setup(){const a=y(),t=y();return{data:a,myForm:t,onSubmit:()=>(console.log(a.value,"submited"),new Promise(r=>{setTimeout(()=>{r()},1e3)})),columns:[{$formkit:"el-switch",name:"a",label:"a",inlinePrompt:!0,value:!0,columnWidth:"100px"},{$formkit:"el-input",name:"b",label:"b"},{$formkit:"el-select",name:"c",label:"c",options:[{label:"1",value:"1"},{label:"2",value:"3"},{label:"3",value:"4"}]}]}}});function A(a,t,l,k,r,C){const p=d("FormKit"),g=d("el-button");return o(),F(b,null,[n(p,{ref:"myForm",type:"el-form",modelValue:a.data,"onUpdate:modelValue":t[0]||(t[0]=e=>a.data=e),onSubmit:a.onSubmit},{footer:h(({disabled:e,node:E})=>[n(g,{loading:e,disabled:e,type:"primary",onClick:E.submit},{default:h(()=>t[1]||(t[1]=[s("提交")])),_:2},1032,["loading","disabled","onClick"])]),default:h(()=>[n(p,{type:"el-array-table",name:"table",label:"table",addLabel:"添加",columns:a.columns},null,8,["columns"])]),_:1},8,["modelValue","onSubmit"]),i("div",null,u(a.data),1)],64)}const v=m(D,[["render",A]]),$=c({name:"InputDemo",setup(){const a=y(),t=y();return{data:a,myForm:t,onSubmit:()=>(console.log(a.value,"submited"),new Promise(r=>{setTimeout(()=>{r()},1e3)})),schema:[{$formkit:"el-array-table",name:"table",label:"table",addLabel:"添加",columns:[{$formkit:"el-switch",name:"a",label:"a",inlinePrompt:!0,value:!0,columnWidth:"100px"},{$formkit:"el-input",name:"b",label:"b"},{$formkit:"el-select",name:"c",label:"c",options:[{label:"1",value:"1"},{label:"2",value:"3"},{label:"3",value:"4"}]}]}]}}});function S(a,t,l,k,r,C){const p=d("FormKitSchema"),g=d("el-button"),e=d("FormKit");return o(),F(b,null,[n(e,{ref:"myForm",type:"el-form",modelValue:a.data,"onUpdate:modelValue":t[0]||(t[0]=E=>a.data=E),onSubmit:a.onSubmit},{footer:h(({disabled:E,node:B})=>[n(g,{loading:E,disabled:E,type:"primary",onClick:B.submit},{default:h(()=>t[1]||(t[1]=[s("提交")])),_:2},1032,["loading","disabled","onClick"])]),default:h(()=>[n(p,{schema:a.schema},null,8,["schema"])]),_:1},8,["modelValue","onSubmit"]),i("pre",null,u(a.data),1)],64)}const K=m($,[["render",S]]),_=JSON.parse('{"title":"表格","description":"","frontmatter":{},"headers":[],"relativePath":"guide/layout/el-array-table.md","filePath":"guide/layout/el-array-table.md","lastUpdated":1751513752000}'),P={name:"guide/layout/el-array-table.md"},x=Object.assign(P,{setup(a){return(t,l)=>{const k=d("demo");return o(),F("div",null,[l[2]||(l[2]=i("h1",{id:"表格",tabindex:"-1"},[s("表格 "),i("a",{class:"header-anchor",href:"#表格","aria-label":'Permalink to "表格"'},"​")],-1)),l[3]||(l[3]=i("h2",{id:"基础用法",tabindex:"-1"},[s("基础用法 "),i("a",{class:"header-anchor",href:"#基础用法","aria-label":'Permalink to "基础用法"'},"​")],-1)),n(k,{customClass:"demoblock-custom",sourceCode:`<template>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"})")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:h(()=>[n(v)]),_:1}),l[4]||(l[4]=i("h2",{id:"schema用法",tabindex:"-1"},[s("schema用法 "),i("a",{class:"header-anchor",href:"#schema用法","aria-label":'Permalink to "schema用法"'},"​")],-1)),n(k,{customClass:"demoblock-custom",sourceCode:`<template>
  <FormKit ref="myForm" type="el-form" v-model="data" @submit="onSubmit">
