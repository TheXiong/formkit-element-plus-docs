import{_ as g,d as y,p as E,B as r,o as d,c as F,G as n,w as k,j as i,t as o,F as m,aS as c,a as s}from"./chunks/framework.BVvxzGKx.js";const u=y({name:"InputDemo",setup(){const a=E(),t=E();return{data:a,myForm:t,onSubmit:()=>(console.log(a.value,"submited"),new Promise(h=>{setTimeout(()=>{h()},1e3)}))}}});function C(a,t,l,h,f,v){const e=r("FormKit");return d(),F(m,null,[n(e,{ref:"myForm",type:"el-form",modelValue:a.data,"onUpdate:modelValue":t[0]||(t[0]=p=>a.data=p),onSubmit:a.onSubmit},{footer:k(({disabled:p})=>[n(e,{type:"submit",disabled:p},null,8,["disabled"])]),default:k(()=>[n(e,{type:"el-input",name:"name",label:"姓名",validation:"required"}),n(e,{type:"el-select",name:"sex",label:"性别",options:[{value:"0",label:"女"},{value:"1",label:"男"}],validation:"required"})]),_:1},8,["modelValue","onSubmit"]),i("div",null,o(a.data),1)],64)}const B=g(u,[["render",C]]),A=JSON.parse('{"title":"FormKit element plus","description":"","frontmatter":{},"headers":[],"relativePath":"guide/index.md","filePath":"guide/index.md","lastUpdated":1730692973000}'),b={name:"guide/index.md"},x=Object.assign(b,{setup(a){return(t,l)=>{const h=r("demo");return d(),F("div",null,[l[1]||(l[1]=c(`<h1 id="formkit-element-plus" tabindex="-1">FormKit element plus <a class="header-anchor" href="#formkit-element-plus" aria-label="Permalink to &quot;FormKit element plus&quot;">​</a></h1><p><a href="https://element-plus.org/">Element plus</a> for <a href="https://formkit.com/">FormKit.</a></p><p>大部分组件是基于 <a href="https://element-plus.org/">Element plus</a>, 属性会直接传递到element plus组件.</p><h2 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h2><p>npm安装</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npm</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> i</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> element-plus</span></span>
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"  },")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"})")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},"</"),i("span",{style:{"--shiki-light":"#22863A","--shiki-dark":"#85E89D"}},"script"),i("span",{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"}},">")])])])],-1)])),default:k(()=>[n(B)]),_:1})])}}});export{A as __pageData,x as default};
